  ...
  return (
    <div className="bg-white p-10 mx-8">
      <div className="flex flex-col gap-6 py-20 items-center">
        ...
        <div className="text-primary-600 text-2xl text-center md:text-start font-black">CE QUE NOUS OFFRONS</div>
        <div className="flex flex-col md:flex-row justify-between items-stretch gap-4 w-full">
          ...
          <div className="flex flex-col gap-4 w-full md:w-1/2 justify-between">
            {solutions.map((item) => (
              <div key={item.title} className="flex flex-col md:flex-row gap-4 items-center">
                <Image
                  src={item.image}
                  alt={item.title}
                  height={80}
          ...
          <div className="w-full md:w-1/2">
            <div className="relative left-0 md:left-16 w-full h-full max-h-[400px] aspect-[3/4]">
              <Image
