        ...
        <div className="bg-white p-10">
            <div className="flex flex-col md:flex-row gap-8 py-20 items-center">
                ...
                <p className="text-black leading-relaxed">
                    <span className="font-bold text-primary">BRIN SERVICE CLEAN</span> est votre partenaire de confiance en nettoyage professionnel. Spécialistes du nettoyage sur mesure, nous intervenons pour les entreprises, les particuliers et les collectivités avec un engagement qualité et un professionnalisme sans compromis.
                </p>
                </div>
